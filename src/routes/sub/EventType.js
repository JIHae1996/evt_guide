...
const EventType = ({ depthIndex, sectionRefs }) => {
  const dataForDepth = eventTypeData[depthIndex] || []; // 현재 depthIndex에 따라 데이터 가져오기

  return (
    <>
      <div className="sections eventType"> {/* sections는 여기서 사용 */}

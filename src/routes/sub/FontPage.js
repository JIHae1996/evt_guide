...
const fontPage = ({ depthIndex, sectionRefs }) => {
  const dataForDepth = fontData[depthIndex] || []; // 현재 depthIndex에 따라 데이터 가져오기

  return (
    <>
      <div className="sections fontpage"> {/* sections는 여기서 사용 */}
